...
import { AiOutlineStepBackward, AiOutlineStepForward, AiFillCaretDown, AiFillCaretUp } from "react-icons/ai";
import { FaPause, FaPlay } from "react-icons/fa6";
import { LuRepeat, LuRepeat1 } from "react-icons/lu";

const MusicController = ({ currentTrack, isPlaying, stopMusic, togglePlay, playPrevious, playNext, audioRef, repeatMode, handleRepeatToggle }) => {
  ...
  return (
    <>
      <button className="toggle-visibility-button" onClick={toggleVisibility}>
