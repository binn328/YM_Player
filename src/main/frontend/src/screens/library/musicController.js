...
import { AiFillCaretDown, AiFillCaretUp, AiOutlineStepBackward, AiOutlineStepForward } from "react-icons/ai";
          ...
          <>
            ...
            <div className="player-controls">
              ...
              <div className="controls">
                <button onClick={playPrevious}><AiOutlineStepBackward /></button>
                <button onClick={togglePlay}>{isPlaying ? <FaPause /> : <FaPlay />}</button>
                <button onClick={playNext}><AiOutlineStepForward /></button>
