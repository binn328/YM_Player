...
import com.binn328.ym_player.Util.Http.HTTPUtil;
...
//      properties.load(AcoustID.class.getResourceAsStream(PROPERTIES));
      final String url = "http://api.acoustid.org/v2/lookup" + "?client=" + System.getenv("ACOUSTID_CLIENT") + "&meta=recordingids" + "&fingerprint=" + chromaprint.chromaprint + "&duration="
